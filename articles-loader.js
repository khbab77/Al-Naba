 $(document).ready(function() {
    ...
    loadLatestArticles('main-news-container', 4);
...
// Function to load latest articles from all categories
function loadLatestArticles(containerId, limit = 6) {
    ...
    // Sort articles by file name (in a real app, you'd sort by date)
    allArticleFiles.sort((a, b) => b.file.localeCompare(a.file));
    
    // Display up to the limit
    container.innerHTML = '';
